...
* How to use : instanciate GeoModelControls after camera setup (setPosition and lookAt)
*/
...
*/
function GeoModelControls(view, options = {}) {
    this.view = view;
    ...
    // starting camera position and orientation target are setup before instanciating GeoModelControls
    ...
    const centerPoint = options.centrePoint || new THREE.Vector3(0, 0, 0);
    // eslint-disable-next-line no-console
    console.log('init centerPoint=', centerPoint);
    ...
    */
    this.initiateDrag = function initiateDrag() {
        ...
        // eslint-disable-next-line no-console
        console.log('worldPtAtScreenCentre=', worldPtAtScreenCentre);
        if (this.extentLimit) {
...
// ===== end of GeoModelControls constructor =====
