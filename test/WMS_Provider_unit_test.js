...
import fs from 'fs';
import { _testing } from '../src/Core/Scheduler/Providers/WMS_Provider';
...
describe('WMS CRS parsing', function () {
...
describe('WMS Format parsing', function () {
...
describe('WMS Extent parsing', function () {
